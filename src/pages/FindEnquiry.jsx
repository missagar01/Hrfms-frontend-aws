...
const rowData = [
  ...
  '',                    // Column K: Last Salary (empty string as before)
 ...
 if (actual2Index !== -1) {
  ...
  // Create date object and format it properly for Google Sheets
  const now = new Date();
  ...
  const actual2Response = await fetch(
    'https://script.google.com/macros/s/AKfycbyWlc2CfrDgr1JGsJHl1N4nRf-GAR-m6yqPPuP8Oggcafv3jo4thFrhfAX2vnfSzLQLlg/exec',
    {
      ...
      body: new URLSearchParams({
        ...
        value: formattedDate // Use the properly formatted date
      }),
    }
  );
