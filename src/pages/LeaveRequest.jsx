...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const rowData = [
      formattedTimestamp,                 // Timestamp (Column A, index 0)
      "",                                // Serial number
      formData.employeeId,               // Employee ID
      formData.employeeName,             // Employee Name
      formatDateForSheet(formData.fromDate), // From Date (Column E, index 4)
      formatDateForSheet(formData.toDate),   // To Date (Column F, index 5)
      formData.reason,                   // Reason
      "Pending",                         // Status
      formData.leaveType,                // Leave Type
      formData.hodName,                  // HOD Name (Column J)
      formData.designation               // Designation (Column K)
    ];
